                ...
                <p class="text-lg text-gray-600 mt-2">Publish on: {{ $data['author_name'] }} , {{$data['created_at']->diffForHumans()}} </p>
                 <div class="mt-8">
                    ...
                    <div class="bg-gray-100 p-4 rounded-lg shadow">
                        ...
                        <div class="mt-4">
                            <button class="text-blue-500 text-sm" onclick="toggleCommentReplyForm({{ $comment->id }})">Reply</button> 

                            <div id="comment-reply-form-{{ $comment->id }}" class="mt-2 hidden">
                        ...
                        @foreach($comment->reply as $reply1)
                            <div class="ml-6 mt-2 bg-gray-200 p-4 rounded-lg shadow">
                                ...
                                <div class="mt-4">
                            <button class="text-blue-500 text-sm" onclick="toggleReplyForm({{ $reply1->id }})">Reply</button>                           
                            <div id="reply-form-{{ $reply1->id }}" class="mt-2 hidden">

                            <form action="{{ route('comments.storeReply', $reply1->id) }}" method="POST">
                                @csrf
